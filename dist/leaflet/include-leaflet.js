...
(function () {
    ...
    function load() {
        ...
        if (inArray(includes, 'd3')) {
            inputScript('../../web/libs/d3/6.1.1/d3.min.js');
        }
        ...
        if (inArray(includes, 'iclient-plot-leaflet')) {
            inputCSS("../../web/libs/plotting/leaflet/10.1.0/iclient-plot-leaflet.css");
            if (supportES6()) {
                inputScript("../../web/libs/plotting/leaflet/10.1.0/iclient-plot-leaflet-es6.min.js");
            } else {
                inputScript("../../web/libs/plotting/leaflet/10.1.0/iclient-plot-leaflet.min.js");
            }
        }
        ...
        if (inArray(includes, 'leaflet-geoman')) {
            inputCSS('../../web/libs/leaflet/plugins/leaflet-geoman/2.7.0/leaflet-geoman.css');
            inputScript('../../web/libs/leaflet/plugins/leaflet-geoman/2.7.0/leaflet-geoman.min.js');
        }
